...
//        this.vulkan13Support = this.device.getCapabilities().apiVersion == VK_API_VERSION_1_3;
    ...
    //Added these to allow detecting GPU vendor, to allow handling vendor specific circumstances: (e.g. such as in case we encounter a vendor specific driver bug)
