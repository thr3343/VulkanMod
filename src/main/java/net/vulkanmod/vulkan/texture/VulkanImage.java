...
public class VulkanImage {
    ...
    public static final boolean useDMA = Vulkan.getDevice().isNvidia(); //TODO: TEMP: replace with granularity check
...
//            Synchronization.INSTANCE.addFence(fence);
    ...
    public void readOnlyLayout() {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            readOnlyLayout(stack, commandBuffer1);
        }
    ...
    public void readOnlyLayout(MemoryStack stack, VkCommandBuffer commandBuffer) {
        transitionImageLayout(stack, commandBuffer, this, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, useDMA);
    }
