...
//        this.vulkan13Support = this.device.getCapabilities().apiVersion == VK_API_VERSION_1_3;
            ...
            this.hasIndexedDescriptors = availableFeatures12.runtimeDescriptorArray() && availableFeatures12.descriptorBindingVariableDescriptorCount() && availableFeatures12.shaderSampledImageArrayNonUniformIndexing();
