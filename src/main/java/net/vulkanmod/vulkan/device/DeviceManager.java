...
public abstract class DeviceManager {
    ...
    public static void createLogicalDevice() {
        try (MemoryStack stack = stackPush()) {
            ...
            final Set<String> optionalExtensions = getAvailableExtension(stack, physicalDevice)
                    .stream()
            ...
            if (optionalExtensions.contains(KHRSynchronization2.VK_KHR_SYNCHRONIZATION_2_EXTENSION_NAME)) {
