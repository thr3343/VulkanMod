...
public abstract class Buffer {
    ...
    public BufferInfo getBufferInfo() { return new BufferInfo(this.id, this.allocation, this.bufferSize, this.type, this.type.equals(MemoryTypes.HOST_MEM) && data==null); }
