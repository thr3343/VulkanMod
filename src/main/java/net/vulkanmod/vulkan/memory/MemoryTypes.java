...
public class MemoryTypes {
    ...
    public static class DeviceLocalMemory extends MemoryType {
        ...
        void copyToBuffer(Buffer buffer, long bufferSize, ByteBuffer byteBuffer) {
            ...
            FakeTransferQueue.copyBufferCmd(stagingBuffer.id, stagingBuffer.offset, buffer.getId(), buffer.getUsedBytes(), bufferSize);
        }
        ...
        public long copyBuffer(Buffer src, Buffer dst) {
            ...
            return FakeTransferQueue.copyBufferCmd(src.getId(), 0, dst.getId(), 0, src.bufferSize);
        }
        ...
        void uploadBuffer(Buffer buffer, ByteBuffer byteBuffer) {
            ...
            FakeTransferQueue.copyBufferCmd(stagingBuffer.id, stagingBuffer.offset, buffer.getId(), 0, bufferSize);
