...
public class DefaultMainPass implements MainPass {
    ...
    private void createRenderPasses() {
        ...
        builder.getDepthAttachmentInfo().setOps(VK_ATTACHMENT_LOAD_OP_DONT_CARE, VK_ATTACHMENT_STORE_OP_STORE);//TOOD: Autooptmse based on COnected RenderPasse/Chains:Use DOn_CARE f Dpeth Read Not required
