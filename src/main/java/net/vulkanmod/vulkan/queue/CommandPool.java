...
public class CommandPool {
    ...
    public static class CommandBuffer {
        ...
        public void wait(Queue queue, MemoryStack stack) {
            VkSemaphoreWaitInfo vkSemaphoreWaitInfo = VkSemaphoreWaitInfo.calloc(stack);
            vkSemaphoreWaitInfo.sType$Default();
            vkSemaphoreWaitInfo.semaphoreCount(1);
            vkSemaphoreWaitInfo.pSemaphores(stack.longs(queue.getTmSemaphore()));
            vkSemaphoreWaitInfo.pValues(stack.longs(this.submitId));
        ...
        public void submitCommands(MemoryStack stack, Queue queue) {
            ...
            submitInfo.pWaitDstStageMask(stack.ints(VK13.VK_PIPELINE_STAGE_NONE)); //No wait stage
