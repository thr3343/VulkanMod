...
public class CommandPool {
    ...
    public final Queue.Family queueType;

    CommandPool(int queueFamilyIndex, Queue.Family queueType) {
    ...
    public static class CommandBuffer {
        ...
        public long submitCommands(MemoryStack stack, Queue queue) {
