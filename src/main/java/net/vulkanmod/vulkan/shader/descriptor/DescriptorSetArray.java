...
//        }
        ...
        boolean needsUpdate = (binding == 0 ? this.initialisedFragSamplers : initialisedVertSamplers)
...
//
            ...
            vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, Renderer.getLayout(),
...
//                case FogColor -> VRenderSystem.getShaderFogColor().ptr;
    ...
    public void bindOnly(int currentFrame, VkCommandBuffer commandBuffer) {
        try(MemoryStack stack = MemoryStack.stackPush())
        {
            vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, Renderer.getLayout(),0, stack.longs(this.descriptorSets[currentFrame]), null);
        }
    }
}
