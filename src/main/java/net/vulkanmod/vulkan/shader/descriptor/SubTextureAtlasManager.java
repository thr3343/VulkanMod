...
public class SubTextureAtlasManager {
    ...
    //Highly flawed, need to replace w/ a better system later
    ...
    public static void invokeUnstitch(ResourceLocation location, int miplevels) {
        //TODO: check Miplevel
       if(Initializer.CONFIG.isDynamicState())
       {
           subTextureAtlasObjectArrayMap.get(location).unStitch(miplevels);
       }
       else subTextureAtlasObjectArrayMap.get(location).unload();
    }
}
