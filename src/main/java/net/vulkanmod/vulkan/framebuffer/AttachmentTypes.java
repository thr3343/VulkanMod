...
public enum AttachmentTypes {
        ...
        COLOR               (COLOR_LAYOUT, DEFAULT_FORMAT, COLOR_USAGE|INPUT_USAGE/*|VK_IMAGE_USAGE_TRANSFER_DST_BIT*/, VK_IMAGE_ASPECT_COLOR_BIT),
        DEPTH               (DEPTH_LAYOUT, depthFormat, DEPTH_USAGE|INPUT_USAGE/*|VK_IMAGE_USAGE_TRANSFER_DST_BIT*/, VK_IMAGE_ASPECT_DEPTH_BIT);
