...
//        this.height=height;
    ...
    public int getStage() {
        return switch (this.type){
            ...
            case PRESENT_SAMPLED, COLOR_SAMPLED, PRESENT_RESOLVE, RESOLVE_COLOR, PRESERVE, INPUT -> VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT;
            case DEPTH_SAMPLED, RESOLVE_DEPTH -> VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT|VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT;
        };
    }
}
