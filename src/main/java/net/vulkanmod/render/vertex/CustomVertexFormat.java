...
public class CustomVertexFormat {
    ...
    public static final VertexFormatElement ELEMENT_POSITION = new VertexFormatElement(0,VertexFormatElement.Type.USHORT, VertexFormatElement.Usage.POSITION, 4);
    public static final VertexFormatElement ELEMENT_POSITION2 = new VertexFormatElement(0,VertexFormatElement.Type.FLOAT, VertexFormatElement.Usage.POSITION, 3);
    ...
    public static final VertexFormat UNCOMPRESSED_TERRAIN = new VertexFormat(new ImmutableMap.Builder<String, VertexFormatElement>()
        .put("Position",ELEMENT_POSITION2).put("Color",ELEMENT_COLOR).put("UV0",ELEMENT_UV0).put("UV2",ELEMENT_UV2).build());
