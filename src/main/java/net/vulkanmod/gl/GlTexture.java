...
public class GlTexture {
    ...
    private void uploadImage(ByteBuffer pixels) {
        ...
        if(internalFormat == GL11.GL_RGB && vulkanImage.format == VK_FORMAT_R8G8B8A8_UNORM) {
            ...
            this.vulkanImage.uploadSubTextureAsync(boundTextureId, 0, width, height, 0, 0, 0, 0, 0, RGBA_buffer);
            MemoryUtil.memFree(RGBA_buffer);
        } else
            this.vulkanImage.uploadSubTextureAsync(boundTextureId, 0, width, height, 0, 0, 0, 0, 0, pixels);
