...
//        }
    ...
    /**
     * @author
     * @reason Looks like Mojang has optimised the lerp functions since 1.19.2/4, so this may not be as effective as prior
     * To compensate, this uses much, much more aggressive Optimisations than the original 1.19.2 commit, and as a result may not reproduce the Sky 100% as accurately to vanilla
     */
