...
public abstract class DebugScreenOverlayM {
    ...
    private ArrayList<String> redirectList(Object[] elements) {
        ...
        strings.add("NativeMemory: %dMB/%dMB".formatted(MemoryTypes.HOST_MEM.usedBytes(), MemoryTypes.HOST_MEM.maxSize()));
        strings.add("UploadMemory: %dMB/%dMB".formatted(MemoryTypes.BAR_MEM.usedBytes(), MemoryTypes.BAR_MEM.maxSize()));
        strings.add("DeviceMemory: %dMB/%dMB".formatted(MemoryTypes.GPU_MEM.usedBytes(), MemoryTypes.GPU_MEM.maxSize()));
        strings.add("");
